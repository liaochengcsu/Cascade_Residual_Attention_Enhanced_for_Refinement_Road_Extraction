...
class LOurDinkNet50(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        super(LOurDinkNet50, self).__init__()
        ...
        # self.decoder4 = DecoderBlock(filters[3], filters[2])
        self.decoder3 = LDecoderBlock(filters[2], filters[1])
        self.decoder2 = LDecoderBlock(filters[1], filters[0])
        self.decoder1 = LDecoderBlock(filters[0], filters[3])
...
class DinkNet50(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.rates = [1, 2, 4, 8]
        self.aspp1 = ASPP_module(1024, 256, rate=self.rates[0])
        ...
        self.sel = SEModule(channels=256, reduction=4)
    ...
    def forward(self, x):
        ...
        e3 = self.sample_conv3(e3)
        # e3 = self.sel(e3)
        e1 = self.sample_conv1(e1) #64
        e2 = self.sample_conv2(e2) #128
